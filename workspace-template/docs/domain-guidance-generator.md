...
When the user or orchestrator explicitly asks for reusable guidance instead of
one-workspace local guidance, use `skills/domain-pack-create.md` to create and
validate a guidance-only domain pack.
...
as reference examples when packaging reusable guidance. For planner-driven
pack creation, follow `skills/domain-pack-create.md`; it requires validator
iteration and a smoke workspace before handoff.
