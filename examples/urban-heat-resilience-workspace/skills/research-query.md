...
9. Read normalized records only for missing details, parse warnings, raw source paths, or source-specific nuance.
10. Compare evidence across pages and sources before summarizing.
11. Identify gaps such as missing source notes, stale pages, conflicting claims, weak evidence, or questions that require new sources.
