...
class EmittedCodeFamilyTests(unittest.TestCase):
    ...
    NOT_ERROR_CODES = {
        ...
        "ROUND_HALF_UP": "Decimal rounding mode used by the computation context",
        "ROUND_HALF_DOWN": "Decimal rounding mode used by the computation context",
        "ROUND_UP": "Decimal rounding mode used by the computation context",
        "ROUND_DOWN": "Decimal rounding mode used by the computation context",
        "ROUND_CEILING": "Decimal rounding mode used by the computation context",
        "ROUND_FLOOR": "Decimal rounding mode used by the computation context",
        "ROUND_05UP": "Decimal rounding mode used by the computation context",
