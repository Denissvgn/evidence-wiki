...
def _classified_exit(load_script: Callable[[str], ModuleType], message: str) -> EvidenceWikiError:
...
def _translated(load_script: Callable[[str], ModuleType], exc: BaseException) -> EvidenceWikiError | None:
    ...
    if isinstance(exc, SystemExit):
        ...
        return _classified_exit(load_script, exc.code) if isinstance(exc.code, str) else None
    return None
...
def call_seam(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        translated = _translated(load_script, exc)
