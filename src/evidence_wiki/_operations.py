...
_ROWS = (
    ...
    ("assessments.prepare", "evidence-wiki assessments prepare", "none", "shared host state lock; immutable workspace capture and current authority", "none"),
    ("assessments.issue", "evidence-wiki assessments issue", "host assessment registration and supersession", "exclusive host state lock; signed command, expected checkpoint and closing input checks", "none"),
    ("assessments.check", "evidence-wiki assessments check", "none", "shared host state lock; current inputs, authority and invalidation state", "none"),
    ("assessments.plan_refresh", "evidence-wiki assessments plan-refresh", "none", "shared host state lock; bounded dependency scan and resume cursor", "none"),
    ("assessments.apply_refresh", "evidence-wiki assessments apply-refresh", "monotone host assessment invalidation and reevaluation records", "exclusive host state lock; signed command, expected checkpoint and recomputed plan", "none"),
